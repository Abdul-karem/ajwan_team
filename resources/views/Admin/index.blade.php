            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="{{ route('categories.index') }}" aria-expanded="false"><i class="fa fa-table"></i><span class="hide-menu">Categories</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{ route('master.index') }}" aria-expanded="false"><i class="fa fa-smile-o"></i><span class="hide-menu">Masters</span></a>

                        <li> <a class="waves-effect waves-dark" href="{{ route('logout') }}" aria-expanded="false"><i class="fa fa-globe"></i><span class="hide-menu">logout</span></a>
                        </li>
                    </ul>
                </nav>
