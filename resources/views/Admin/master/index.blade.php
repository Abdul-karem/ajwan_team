  ...
  <table class="table">
      ...
      <div class="row align-items-start" style="margin-top: 30px">
          <div class="col">
            ...
            <a class="btn btn-success" href="{{ route('master.create') }}">Create</a>
         </div>
      </div>
  ...
  <table class="table table-striped table-hover table-bordered table-primary align-middle">
      ...
      <tbody>
          ...
          <tr>
              ...
              <td>
                  <a href="{{ route('master.edit', $item->id) }}" class="btn btn-primary btn-sm">Edit</a>
                  <form action="{{ route('master.destroy', $item->id) }}" method="post" style="display: inline;">
                      @csrf
                      @method('DELETE')
